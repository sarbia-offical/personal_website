...
export const Top: FC = () => {
    ...
    useEffect(() => {
        if (textRef.current) {
            ...
            if (ele && cursorAngle) {
                const shadowX = Math.cos((cursorAngle * Math.PI) / 180) * 2;
                const shadowY = Math.sin((cursorAngle * Math.PI) / 180) * 2;
    ...
    const handleMouseMove = useCallback(
        _.throttle((e: React.MouseEvent<HTMLDivElement, MouseEvent>) => {
    ...
    return (
        <div className={$styles.top} onMouseMove={handleMouseMove}>
            ...
            <div className={$styles.top_inner}>
                ...
                <p className={$styles.top_inner_title} ref={textRef}>
                    D&D,
                </p>
